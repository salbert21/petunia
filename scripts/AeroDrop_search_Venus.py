...
# =============================================================================
# comment/uncomment the below blocks of code for desired scenario at Venus
# =============================================================================
#### Make all BC and efpa ranges the same ####
BCList = np.arange(10, 200, 2.5)
efpaList = np.arange(-3.5, -7.5, -0.02)
...
# =============================================================================
# =============================================================================
### INPUT ATM TABLE - GET ATM TABLE FROM VENUSGRAM DATA FILE
params.dMode = 'table'
...
tspan = (0,5000) # don't make too long or results get choppy!

# exit conditions:
params.hmin = 75
params.hmax = params.p.halt + 1e-7 +  20
